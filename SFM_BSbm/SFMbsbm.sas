...
* Quantlet:     SFMbsbm
* -------------------------------------------------------------------------
* Description:  SFMbsbm plots BS price as a function of a Brownian Motion
*               S_t
*--------------------------------------------------------------------------
* Usage:        
*--------------------------------------------------------------------------
...
Call_Put =  j(nrow(St),2,0);

*Calculate Black Scholes prices as a function of S;

do i  =  1 to nrow(St);
Call_Put[i,]  =   blsprice(St[i,1], K, r, si, tau);
end;

call_put = t||st||call_put;
